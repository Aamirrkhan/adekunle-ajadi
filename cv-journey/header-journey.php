...
<head>
  ...
  <link rel="stylesheet" href="responsive-cv-journey.css" />
          ...
          <div class="navbar-head">
            <div class="d-flex justify-content-end">
              <ul class="d-flex justify-content-between align-items-center navlist-head mobile-humber">
                ...
                <li class="none-header"><a href="../index.php" class="login-btn-header humber-show">Log in</a></li>
              ...
              <ul class="d-flex justify-content-between align-items-center navlist-head">
                ...
                <li class="login-none"><a href="../index.php" class="login-btn-header">Log in</a></li>
