                ...
                <div class="col-xl-6 col-lg-9 col-md-12">
                    <div class="forget-sec">
                        ...
                        <p class="para-forget">
                            ...
                            resent information sent to
                        </p>
                        <div class="input-fields-center mb-4"><input type="email" placeholder="Enter your email" class="forget-email"></div>

                        <div class="text-center"><button class="submit-forget">Continue</button></div>
                    </div>
                </div>
            </div>
        </div>
