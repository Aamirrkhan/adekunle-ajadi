            ...
            <div class="cont-bg-set">
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-9">
                        <div class="step-hd">
                            <h1>Templates for 3 years or less experience</h1>
                            <p class="step-center-para mt-4">Choose Template Later</p>
                        </div>
                    </div>
                    <div class="col-12 col-lg-9">
                        <div class="d-flex justify-content-between set-boder-inle">
                            <ul class="tabs d-flex gap-4 flex-wrap temp-tabz">
                                <li data-tab-target="#All-tabs" class="active tab">Recommended Templates</li>
                                <li data-tab-target="#A-tabs" class="tab">View All Templates</li>
                            </ul>
                            <ul class="tabs d-flex gap-4 flex-wrap temp-tabz">
                                <li class="d-flex align-items-center tab"> Try Other Colors:
                        ...
                        <div class="tab-content set-mrgn-top">
