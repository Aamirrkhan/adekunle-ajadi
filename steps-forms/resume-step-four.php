            ...
            <div class="cont-bg-set">
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-9">
                        <div class="step-hd">
                            <h1>Did you graduate from high school?</h1>
                        ...
                        <form action="">
                            <div class="d-flex justify-content-center fields-row">
                                <div class="btns-radios label-pd-two">
                                    <input type="radio" placeholder="Build a New Resume" id="Yes" name="resume">
                                    <label class="btns-form" for="Yes">
                                    Yes
                                    </label>
                                </div>
                                <div class="btns-radios label-pd-two">
                                    <input type="radio" placeholder="Build a New Resume" id="Still" name="resume">
                                    <label class="btns-form" for="Still">
                                    Still enrolled
                                    </label>
                                </div>
                                <div class="btns-radios label-pd-two">
                                    <input type="radio" placeholder="Build a New Resume" id="No" name="resume">
                                    <label class="btns-form" for="No">
                                    No
                                    </label>
                                </div>
                            </div>
