                        ...
                        <form action="">
                            <div class="d-flex justify-content-center fields-row">
                                <div class="btns-radios label-pd-two">
                                    <input type="radio" placeholder="Build a New Resume" id="school" name="resume">
                                    <label class="btns-form" for="school">
                                        High School
                                    </label>
                                </div>
                                <div class="btns-radios label-pd-two">
                                    <input type="radio" placeholder="Build a New Resume" id="College" name="resume">
                                    <label class="btns-form" for="College">
                                        College/University
                                    </label>
                                </div>
                                <div class="btns-radios label-pd-two">
                                    <input type="radio" placeholder="Build a New Resume" id="Other" name="resume">
                                    <label class="btns-form" for="Other">
                                    Other
                                    </label>
                                </div>
